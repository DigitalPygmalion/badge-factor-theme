                ...
                <?php if(is_user_logged_in()): ?>
                    ...
                    <?php if(!empty($current_user->user_login)): ?>
                        <li class="header-main-top-sublist-item">
                            <a class="header-main-top-sublist-link <?php !bp_is_my_profile() ?: print 'current'; ?>" href="<?php echo  bp_loggedin_user_domain( get_current_user_id() ) . 'profile/'; ?>"><?php _e('My account', 'badgefactor-theme'); ?></a>
                        </li>
                    <?php endif; ?>
                    <li class="header-main-top-sublist-item">
